...
public class ModItems {
    ...
    public static final RegistryObject<Item> BLADE_OF_ANUBIS = ITEMS.register("blade_of_anubis", BladeOfAnubis::new);
    ...
    public static final RegistryObject<Item> DEMONLORD_SWORD = ITEMS.register("demonlord_sword", DemonlordSword::new);
    ...
    public static final RegistryObject<Item> FALLEN_GOD_SWORD = ITEMS.register("fallen_god_sword", FallenGodSword::new);
    ...
    public static final RegistryObject<Item> RIVERS_OF_BLOOD = ITEMS.register("rivers_of_blood", RiversOfBlood::new);
    ...
    public static final RegistryObject<Item> DIVINE_PUNISHER = ITEMS.register("divine_punisher", DivinePunisher::new);
    ...
    public static final RegistryObject<Item> FALLEN_GOD_SPEAR = ITEMS.register("fallen_god_spear", FallenGodSpear::new);
    ...
    public static final RegistryObject<Item> FROST_SCYTHE_AXE = ITEMS.register("frost_scythe_axe", FrostScytheAxe::new);
